...
class ProductController extends AbstractController
{
    ...
    public function edit($id, ProductRepository $productRepository, Request $request, EntityManagerInterface $em, SluggerInterface $slugger) //la request pour le submit du formulaire et $em pour les modif dans la bdd
    {
        ...
        if($form->isSubmitted()){
            ...
            $em->flush(); // pas besoin de persiste pcq le produit exist déjà, ce flush confirme les modifications
